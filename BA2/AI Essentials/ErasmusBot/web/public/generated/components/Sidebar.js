(() => {
  ...
  var ChatBubbleBottomCenterTextIcon_default = ForwardRef;
  ...
  // src/components/Sidebar.tsx
  var Sidebar = class extends import_react.Component {
    constructor(props) {
      super(props);
      this.state = {
        currentChat: "",
    ...
    render() {
      if (!this.state.show) {
        return /* @__PURE__ */ import_react.default.createElement("div", { className: "bg-white flex p-5" }, /* @__PURE__ */ import_react.default.createElement(ChatBubbleBottomCenterTextIcon_default, { onClick: () => {
          this.setState({
            ...this.state,
            show: true
          });
      ...
      return /* @__PURE__ */ import_react.default.createElement("div", { className: "flex flex-col items-start flex-none w-36 p-5 bg-amber-50 space-y-5" }, /* @__PURE__ */ import_react.default.createElement("div", { onClick: () => {
        this.setState({
          ...this.state,
          show: false
        });
      } }, /* @__PURE__ */ import_react.default.createElement(ChatBubbleBottomCenterTextIcon_default, { className: "h-5 w-5 hover:cursor-pointer" })), /* @__PURE__ */ import_react.default.createElement("div", { className: "rounded-xl bg-gray-200 p-2 hover:cursor-pointer text-center" }, /* @__PURE__ */ import_react.default.createElement("span", null, "New chat")), this.props.data.length > 0 && /* @__PURE__ */ import_react.default.createElement("span", null, "Past chats"), this.props.data.length > 0 && this.props.data.map((chat) => {
        ...
        return /* @__PURE__ */ import_react.default.createElement(
          ...
          /* @__PURE__ */ import_react.default.createElement("h1", null, chat.name)
        );
      }), /* @__PURE__ */ import_react.default.createElement("div", { className: "flex justify-self-end" }, /* @__PURE__ */ import_react.default.createElement(
        "button",
        {
          className: "bg-gray-200 p-2 rounded-xl hover:cursor-pointer",
          onClick: () => {
            axios_default.post(`${BASE_URL}/api/logout`).then((res) => {
