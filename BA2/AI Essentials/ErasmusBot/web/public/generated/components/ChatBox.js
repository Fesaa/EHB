(() => {
  ...
  var PaperAirplaneIcon_default = ForwardRef;

  // src/components/ChatBox.tsx
  var ChatBox = class extends import_react.Component {
    constructor(props) {
      super(props);
      this.state = {
        full: null,
    ...
    shouldComponentUpdate(nextProps, nextState, nextContext) {
      ...
      axios_default.get(`${BASE_URL}/api/chats/full/${nextProps.id}`).then((res) => {
        if (!res || !res.data)
          return;
        this.setState({
          ...this.state,
    ...
    render() {
      if (this.state.full == null && this.props.id !== "") {
        return /* @__PURE__ */ import_react.default.createElement("div", { className: "flex flex-grow" }, /* @__PURE__ */ import_react.default.createElement("h1", null, "Loading..."));
      }
      return /* @__PURE__ */ import_react.default.createElement("div", { className: "flex flex-col flex-grow items-center px-40" }, /* @__PURE__ */ import_react.default.createElement("span", { className: "text-2xl mt-10 fixed top-5" }, this.state.full && this.state.full.name), /* @__PURE__ */ import_react.default.createElement("div", { className: "flex flex-grow flex-col mx-10 my-20 space-y-5 w-full overflow-auto" }, this.state.full && this.state.full.chatHistory.map((msg, index) => {
        return /* @__PURE__ */ import_react.default.createElement("div", { key: `message_${index}`, className: `flex flex-row ${msg.user ? "justify-end" : "justify-start"} mx-10 my-2` }, /* @__PURE__ */ import_react.default.createElement("div", { className: `${msg.user ? "bg-red-200" : "bg-blue-200"} p-5 rounded-xl max-w-64` }, msg.text));
      })), /* @__PURE__ */ import_react.default.createElement("div", { className: "mb-10 fixed -bottom-5 flex flex-row space-x-5 justify-center items-center" }, /* @__PURE__ */ import_react.default.createElement(
        "input",
        {
          type: "text",
      ...
      ), /* @__PURE__ */ import_react.default.createElement(PaperAirplaneIcon_default, { className: "w-8 h-8 hover:cursor-pointer", onClick: (e) => this.sendMessage() })));
    }
  };
})();
